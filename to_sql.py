...
df_diplomatic = pd.read_csv('diplomatic.csv')
...
df_ucdp_all = pd.read_csv('ucdp_articles_all.csv')
...
df_cameo = pd.read_csv('CAMEO.eventcodes.txt', sep='\t', dtype={'CAMEOEVENTCODE': str})
df_cameo.columns = df_cameo.columns.str.lower()
df_ucdp_events = pd.read_csv('ucdp_unique.csv')
target_columns = [
...
df_conflicts = pd.read_csv('conflicts_enriched.csv')
...
df_diplomatic.to_csv('diplomatic_clean.csv', index=False)